...
#     # Example usage
#     pdf_path = Path('2021 Analytics Exchange - Mapping Choropleths in Your Reports and Dashboards.pdf')
#     output_folder = 'out_images'
#     pdf_to_images(pdf_path, output_folder)
    
#     output_zip_file = 'zipped_images.zip'
#     zip_folder(output_folder, output_zip_file)